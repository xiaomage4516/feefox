...
cc.Class({
    ...
    refresh (data) {
        ...
        for (var i = 0; i < data.players.length; i++) {
            ...
            util.loadSprite("hall/bag/prop/"+playerData.headImage, playerItem.getChildByName("frame"), function (node) {
                node.active = true;
            });
            ...
            // name
            playerItem.getChildByName("name").getComponent(cc.Label).string = decodeURIComponent(playerData.name);
            ...
            // win_num
            playerItem.getChildByName("win_num").getComponent(cc.Label).string = ""+playerData.win;
